  ...
  function handleSubmit(event) {
    ...
    axios
      ...
      .then((response) => {
        ...
        } else if (serverResponse === "Account not exist, Try SignUp") {
          setreturnMessage("Account not exist, SignUp Now !");
          setIsVisible(true);
        } else {
          setreturnMessage(
            "your password was incorrect. Try again with correct password"
          );
          setIsVisible(true);
        }
      })
    ...
    <div className="login-container">
      <div className="login-form">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <Link className="forgot-password" to="/workinprogress">
            Forgot password?
          </Link>
